                ...
                <tr>
                    ...
                    <td>
                        <label class="badge badge-info">
                            <a href="{{ route('admin.editnextpageshow', ['getId' => $item->Ibtn_id]) }}">Edit</a>
                        </label>
                        {{--  <label class="badge badge-danger">
                            <a href="#" >Delete</a>
                        </label>  --}}
                        <form action="{{ route('admin.deletnextpageshow', ['id' => $item->Ibtn_id]) }}" method="POST" style="display:inline;">
                            @csrf
                            @method('post')
