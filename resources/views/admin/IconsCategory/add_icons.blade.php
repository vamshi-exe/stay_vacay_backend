                ...
                <div class="col-md-6 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="forms-sample" method="post" action="{{ url('/admin/icons/saveicons') }}" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                    <label>Icons Name</label>
                                    <input type="text" class="form-control" name="iconsName" id="exampleInputUsername1" placeholder="Country name" required>
                                </div>
                                <div class="form-group">
